...
from utils.mae_pretrain_baseline import Trainer
from dataset.dataloader import NLSTDataset_MAEPretrain_Baseline #NLSTDataset
...
def main(args):
    ...
    train_dataset = NLSTDataset_MAEPretrain_Baseline(
    ...
    if args.augs:
        ...
        train_dataset = torch2torchiodataset(train_dataset, aug_process, transform=args.transform_type, downsample=args.downsample, mae_pretrain=True)
        print("done")
    ...
    val_dataset = NLSTDataset_MAEPretrain_Baseline(
        data_dir=args.data_dir,
        json_file=args.json_file,
        mode="val",
        downsample=args.downsample,
